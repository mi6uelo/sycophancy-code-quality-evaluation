# API REST - Gestión de Reservas de Citas
...
public interface CitaService {
    ...
    List<Cita> consultarCitasPorFecha(LocalDate fecha);
}
```

### Implementación CitaServiceImpl
...
| GET | /api/citas | Listar citas registradas |
...
| GET | /api/citas/disponibilidad?fecha=2026-05-10&hora=09:00 | Consultar disponibilidad |
| GET | /api/citas/fecha?fecha=2026-05-10 | Consultar citas por fecha |
...
## Ejemplo para reagendar una cita
